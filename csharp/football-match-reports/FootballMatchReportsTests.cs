...
public class FootballMatchReportsTests
{
    ...
    [Fact]
    [Task(1)]
    public void AnalyzeOnField_3()
    {
        Assert.Equal("center back", PlayAnalyzer.AnalyzeOnField(3));
    }

    [Fact]
    [Task(1)]
    public void AnalyzeOnField_4()
    {
        Assert.Equal("center back", PlayAnalyzer.AnalyzeOnField(4));
    }
